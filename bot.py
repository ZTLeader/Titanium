...
# it will print bot user when bot is ready
@bot.event
async def on_ready():
    print(f'Bot is ready. Logged in as {bot.user}')

# !start will send you hello message
...
async def start_command(ctx):
    ...
    await info(ctx)
# !info will send you info messages
...
# !new_projects will make you a new project
...
# !projects will open all of your projects
...
# !skills will add skill to your project
...
async def skills(ctx):
    ...
    if projects:
        ...
        await ctx.send('Kamu belum memiliki proyek!\nKamu dapat menambahkannya menggunakan perintah !new_project')
# !delete will delete your project
...
async def delete_project(ctx):
    ...
    if projects:
        ...
        await ctx.send('Kamu belum memiliki proyek!\nKamu dapat menambahkannya menggunakan perintah !new_project')
# !update_projects will update all your projects
